...
def test_initializer_defaults_path(configurer_json):
    assert configurer_json.path == "$HOME/.config/test_app/test_app.yml"
...
def test_initialize_with_yaml(mocker, configurer_yaml):
    ...
    mock_yaml_manager.assert_called_once_with(content={"key": "value"}, path="$HOME/.config/test_app/test_app.yml")
...
def test_initialize_with_json(mocker, configurer_json):
    ...
    mock_json_manager.assert_called_once_with(content={"key": "value"}, path="$HOME/.config/test_app/test_app.yml")
...
def test_read_configuration_with_yaml(mocker, configurer_yaml):
    ...
    mock_yaml_manager.assert_called_once_with(path="$HOME/.config/test_app/test_app.yml")
...
def test_read_configuration_with_json(mocker, configurer_json):
    ...
    assert result == {"key": "value"}
    mock_json_manager.assert_called_once_with(path="$HOME/.config/test_app/test_app.yml")
